 ...
 *
 * Example:
 * Input  : "London", "tableFirst"
 * Output: "***London***", 500
 *
 */

public class SampleUDTF_SparkApp_v1_local extends GenericUDTF {
    ...
    Long sparkJob(String tableName)
    {
        SparkSession spark = SparkSession
                .builder()
                .master("local")
                .enableHiveSupport()
                .appName("SampleUDTF_SparkApp_v1_local")
                .getOrCreate();
